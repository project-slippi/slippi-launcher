...
export function extractPlayerNames(
  ...
  result.name = player?.displayName || (get(metadata, ["players", index, "names", "netplay"]) as string | null) || "";
  result.code = player?.connectCode || (get(metadata, ["players", index, "names", "code"]) as string | null) || "";
