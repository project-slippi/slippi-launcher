...
export const useIsoPath = () => {
  ...
  const setPath = useCallback(async (isoPath: string | null) => {
...
export const useRootSlpPath = () => {
  ...
  const setReplayDir = useCallback(async (path: string) => {
...
export const useMonthlySubfolders = () => {
  ...
  const setUseMonthlySubfolders = useCallback(async (toggle: boolean) => {
...
export const useSpectateSlpPath = () => {
  ...
  const setSpectateDir = useCallback(async (path: string) => {
...
export const useExtraSlpPaths = () => {
  ...
  const setExtraSlpDirs = useCallback(async (paths: string[]) => {
...
export const useDolphinPath = (dolphinType: DolphinLaunchType) => {
  ...
  const setNetplayPath = useCallback(async (path: string) => {
  ...
  const setDolphinPath = useCallback(async (path: string) => {
...
export const useLaunchMeleeOnPlay = () => {
  ...
  const setLaunchMelee = useCallback(async (launchMelee: boolean) => {
